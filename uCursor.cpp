...
//---------------------------------------------------------------------------
//auto generation has to be executed manually by "./autogen uCursor.cpp uCursor.h" in an environment with working perl every time a maintainer wants the autogenerated interface to be up-to-date
/*AUTOINCLUDE_BODY_CIter_uIter.h*/
      ...
      /*AUTOGENERATED*/ bool  CIter::IsUnderCursor (const wchar_t *& string, bool caseSensitive, bool wholeword)  { Init();  return  this->itr.IsUnderCursor (string,caseSensitive,wholeword);}   //used as test for search;
