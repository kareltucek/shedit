...
namespace SHEdit
{
  ...
  class CIter
  {
    ...
    public:
      ...
      /*AUTOGENERATED*/ void  GoWordLiteral ()  ;                                                    /*!< goes to next start of a word (alnum + underscore) */
      /*AUTOGENERATED*/ void  RevWordLiteral ()  ;                                                   /*!< goes to previous start of a word (alnum + underscore) */
      ...
      /*AUTOGENERATED*/ bool  IsUnderCursor (const wchar_t *& string, bool caseSensitive, bool wholeword)  ; /*!< Tests if the string is at the position of cursor. Serves for FindNext/FindNext. */
